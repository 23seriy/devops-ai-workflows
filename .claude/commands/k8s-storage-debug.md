...
- **PV Released** → reclaim policy is `Retain`; a cluster admin must manually delete the PV outside this workflow, only after verifying the data it held is no longer needed.
